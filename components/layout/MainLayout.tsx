...
export const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
    ...
    return (
        <div className={`flex h-screen w-full bg-[#050505] text-gray-300 transition-all duration-700 relative ${screenEffect === 'fail' ? 'animate-shake bg-red-950/25' : screenEffect === 'crit' ? 'shadow-[inset_0_0_200px_rgba(234,179,8,0.2)]' : ''}`}>
